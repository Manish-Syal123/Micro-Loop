        ...
        <div className="relative pt-36 ml-auto">
          <div className="lg:w-2/3 text-center mx-auto">
            ...
            <p className="mt-8 text-gray-700 dark:text-gray-300">
              Micro Loop is a collaborative workspace that lets teams create,
            ...
            <div className="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8">
              ...
              <div className="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-32">
                <div className="mx-auto max-w-sm lg:max-w-none">
                  <p className="mt-4 text-center text-gray-500 lg:text-left lg:text-lg">
                    Micro Loop is a collaborative workspace that lets teams
              ...
              <div className="mt-16 border-t border-gray-100 pt-8">
                <p className="text-center text-xs/relaxed text-gray-500">
                  © Micro Loop {new Date().getFullYear()}. All rights reserved.
                  <br />
                  Created by{" "}
                  <a
                    href="https://manish-syal123.github.io/Final_Portfolio_Responsive"
                    target="_blank"
